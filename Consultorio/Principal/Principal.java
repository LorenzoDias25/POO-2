...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        char op, menup, menum, menuc, list;
        String menu = "Menu "
                + "\n(P) Pacientes"
                + "\n(M) Medicos"
                + "\n(C) Consultas"
        ...
        String listdata = "Listar consultas "
                + "\n(D) Data"
                + "\n(M) Medico"
                + "\n(P) Paciente"
                + "\n(T) Todas "
            ...
            switch(op){
                ...
                case 'c': {
                    ...
                    switch (menuc){
                        case 'L':
                        case 'l': {
                            list = JOptionPane.showInputDialog(listdata).charAt(0);
                            switch(list){
                                case 'D': 
                                case 'd': {
                                    C_Consultas.Listardata(Consulta);
                                }break;
                                case 'M': 
                                case 'm': {
                                    C_Join.Listarmed(Join);
                                }break;
                                case 'P':
                                case 'p': {
                                    C_Join.Listarpac(Join);
                                }break;
                                case 'T': 
                                case 't': {
                                    C_Consultas.Listar(Consulta);
                                }break;
                                case 'C': 
                                case 'c': {
                                }break;
